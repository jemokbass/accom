...
const navLinks = document.querySelector('.header-menu__nav-inner'),
  hamburger = document.querySelector('.header-hamburger'),
  blurbg = document.querySelector('.blur');
...
document.addEventListener('click', e => {
  e.target && e.target.closest('.header-hamburger') === hamburger ? toggle() : e.target.closest('.header-menu__nav-inner') !== navLinks ? remove() : false;
});

let swiper = new Swiper('.car-slider__container', {
  pagination: {
...
const btnDirection = document.querySelector('.direction-header__btn-link'),
  directionColOne = document.querySelectorAll('.direction-row__column--1'),
  directionColTwo = document.querySelectorAll('.direction-row__column--2');

btnDirection.addEventListener('click', (e) => {
  e.preventDefault();
  directionColOne.forEach((i) => {
    i.classList.toggle('active')
  });
  directionColTwo.forEach((i) => {
    i.classList.toggle('active')
  });
})

const deliverance = document.querySelector('.deliverance__row--3'),
  deliveranceBtn = document.querySelector('.deliverance__more-btn');

deliveranceBtn.addEventListener('click', (e) => {
  e.preventDefault();
  deliverance.classList.add('active');
  deliveranceBtn.remove();
})
//
if (innerWidth < 604) {
  let serviceColumn = document.querySelectorAll('.service-column');
  for (let i = 3; i < serviceColumn.length; i++) {
    let j = serviceColumn[i];
    j.classList.toggle('active');

  }
  const servInn = document.querySelector('.service__inner');
  servInn.insertAdjacentHTML('beforeend', '<a class="service-btn" href="#">Show more</a>')
  const servBtn = document.querySelector('.service-btn');
...
const routeBtn = document.querySelectorAll('.route-tabs__wrapper-btn');
const routeFir = document.querySelector('.form-tabs__inner');
const routeSec = document.querySelector('.route-nearly');
...
routeBtn.forEach((i) => {
  i.addEventListener('click', (e) => {
    ...
    routeFir.classList.remove('active')
    routeSec.classList.remove('active')
...
const im = new Inputmask('+9 (9 9 9) 9 9 9 - 9 9 - 9 9')
im.mask(selectorTel)
...
const modal = document.querySelector('.modal'),
  back = document.querySelector('.black-bg'),
  modalBbtn = document.querySelectorAll('.modal-btn'),
  bodyL = document.querySelector('body'),
